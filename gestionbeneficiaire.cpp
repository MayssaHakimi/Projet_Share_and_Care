...
Gestionbeneficiaire::Gestionbeneficiaire(QWidget *parent)
   : QMainWindow(parent)
    , ui(new Ui::Gestionbeneficiaire)
{
   ui->setupUi(this);
...
Gestionbeneficiaire::~Gestionbeneficiaire()
{
   delete ui;
}
...
//ajout
void Gestionbeneficiaire::on_pushButton_clicked()
{
...
void Gestionbeneficiaire::on_pushButton_2_clicked()
{
    int id_ben=ui->lineEdit_id->text().toInt();
...
//affichage
void Gestionbeneficiaire::on_pushButton_3_clicked()
{
    int id_ben=ui->lineEdit_id->text().toInt();
    QString nom_ben=ui->lineEdit_nom->text();
    QString prenom_ben=ui->lineEdit_prenom->text();
...
/*void Gestionbeneficiaire::on_pushButton_tri_clicked()
{
    QSqlQueryModel* sortedModel = B.tri();
    ui->tab_aff->setModel(sortedModel);
}*/
void Gestionbeneficiaire::on_pushButton_tri_2_clicked()
{
...
void Gestionbeneficiaire::on_pushButton_pdf_clicked()
{
    QString strStream;
...
void Gestionbeneficiaire::on_pushButton_rech_clicked()
{
...
void Gestionbeneficiaire::on_histbouton_clicked()
{
    QFile file ("C:/Users/Mohamed Amine/Desktop/ben/history.txt");
...
void Gestionbeneficiaire::on_mailbutt_clicked()
{
...
void Gestionbeneficiaire::on_statbutton_clicked()
{
...
void Gestionbeneficiaire::on_aff_clicked()
{
    int id_ben=ui->lineEdit_id->text().toInt();
    QString nom_ben=ui->lineEdit_nom->text();
    QString prenom_ben=ui->lineEdit_prenom->text();
