...
Gestiondon::Gestiondon(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::Gestiondon)
{
    ui->setupUi(this);
...
void Gestiondon::appendMessage(const QString &from, const QString &message)
{
...
void Gestiondon::newParticipant(const QString &nick)
{
    if (nick.isEmpty())
        return;
...
void Gestiondon::participantLeft(const QString &nick)
{
    if (nick.isEmpty())
        return;
...
void Gestiondon::showInformation()
{
...
void Gestiondon::on_pushButton_3_clicked()
{
...
void Gestiondon::on_pushButton_20_clicked()
{
    QSqlQuery query;
    query.exec("SELECT id_don FROM DONS");
...
void Gestiondon::on_pushButton_19_clicked()
{
    QString nom_don=ui->lineEdit->text();
    QString prenom_don=ui->lineEdit_3->text();
    QString cin_don=ui->lineEdit_2->text();
...
void Gestiondon::on_pushButton_22_clicked()
{
    ui->tab_affiche_2->setModel(Do.trieAsc());
}

void Gestiondon::on_pushButton_23_clicked()
{
...
void Gestiondon::on_comboBox_3_currentIndexChanged(const QString& id_don)
{
    QSqlQuery query;
...
//PDF
void Gestiondon::on_pushButton_24_clicked()
{
...
void Gestiondon::on_pushButton_10_clicked()
{
statistique_don();
}
